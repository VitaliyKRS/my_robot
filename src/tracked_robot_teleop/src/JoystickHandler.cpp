...
JoystickHandler::JoystickHandler(const std::string &name) : rclcpp::Node(name, rclcpp::NodeOptions().use_intra_process_comms(true))
{
    ...
    update_timer_ = create_wall_timer(std::chrono::milliseconds(100), std::bind(&JoystickHandler::update, this));
