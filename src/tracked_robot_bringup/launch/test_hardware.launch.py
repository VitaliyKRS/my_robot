...
def generate_launch_description():
    ...
    tracked_robot_nav_path = get_package_share_directory('tracked_robot_navigation')
    robot_localization_file_path = os.path.join(tracked_robot_nav_path, 'config', 'ekf_with_gps.yaml')
